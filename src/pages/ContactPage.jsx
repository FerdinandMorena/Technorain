            ...
            <div className="grid lg:grid-cols-5 gap-12">
              ...
              <div className="lg:col-span-2 space-y-8 text-sm md:text-md lg:text-lg">
                ...
                <div className="space-y-6">
                  {/* Phone */}
                  <div className="group glass-effect rounded-2xl p-6 border border-border/50 hover:border-primary/50 transition-all duration-300">
                  ...
                  <div className="group glass-effect rounded-2xl p-6 border border-border/50 hover:border-primary/50 transition-all duration-300">
                    <div className="flex items-start gap-4">
                      <div className="relative">
                        <div className="absolute inset-0 bg-primary/20 blur-xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity" />
                        <div className="relative w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center">
              ...
              <div className="lg:col-span-3">
                <div className="glass-effect rounded-2xl p-8 md:p-10 border border-border/50">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        id="name"
                        required
                        className="w-full px-4 py-3 rounded-xl glass-effect border border-border/50 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        rows={6}
                        required
                        className="w-full px-4 py-3 rounded-xl glass-effect border border-border/50 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all resize-none"
                    ...
                    <Button
                      type="submit"
                      size="lg"
                      className="w-full bg-gradient-primary hover:shadow-2xl hover:shadow-primary/50 transition-all duration-300 group"
                    >
